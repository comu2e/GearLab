...
class IgnitionServiceProvider extends ServiceProvider
{
    public function boot()
    {
        if ($this->app->runningInConsole()) {
            $this->publishes([
                __DIR__.'/../config/flare.php' => config_path('flare.php-fpm'),
            ], 'flare-config');

            $this->publishes([
                __DIR__.'/../config/ignition.php' => config_path('ignition.php-fpm'),
            ], 'ignition-config');
        }
    ...
    protected function registerViewEngines()
    {
        ...
        $this->app->make('view.engine.resolver')->register('php-fpm', function () {
    ...
    protected function hasCustomViewEnginesRegistered()
    {
        ...
        if (! $resolver->resolve('php-fpm') instanceof LaravelPhpEngine) {
            return false;
        }
