...
class Inspector
{
    ...
    /**
     * Returns a url to the php-fpm-manual related to the underlying error - when available.
     *
     * @return string|null
     */
    ...
    private function extractDocrefUrl($message)
    {
        ...
        // php-fpm embbeds urls to the manual into the Exception message with the following ini-settings defined
