<?php
/**
 * Whoops - php-fpm errors for cool kids
...
class PrettyPageHandler extends Handler
{
    ...
    public function __construct()
    {
        ...
        // blacklist php-fpm provided auth based values
    ...
    public function handle()
    {
        ...
        $templateFile = $this->getResource("views/layout.html.php-fpm");
        ...
        $vars = [
            ...
            // Template paths:
            "header"                     => $this->getResource("views/header.html.php-fpm"),
            "header_outer"               => $this->getResource("views/header_outer.html.php-fpm"),
            "frame_list"                 => $this->getResource("views/frame_list.html.php-fpm"),
            "frames_description"         => $this->getResource("views/frames_description.html.php-fpm"),
            "frames_container"           => $this->getResource("views/frames_container.html.php-fpm"),
            "panel_details"              => $this->getResource("views/panel_details.html.php-fpm"),
            "panel_details_outer"        => $this->getResource("views/panel_details_outer.html.php-fpm"),
            "panel_left"                 => $this->getResource("views/panel_left.html.php-fpm"),
            "panel_left_outer"           => $this->getResource("views/panel_left_outer.html.php-fpm"),
            "frame_code"                 => $this->getResource("views/frame_code.html.php-fpm"),
            "env_details"                => $this->getResource("views/env_details.html.php-fpm"),

            "title"            => $this->getPageTitle(),
            "name"             => explode("\\", $inspector->getExceptionName()),
            "message"          => $inspector->getExceptionMessage(),
            "previousMessages" => $inspector->getPreviousExceptionMessages(),
            "docyoutube_url"       => $inspector->getExceptionDocrefUrl(),
            "code"             => $code,
    ...
    protected function getExceptionCode()
    {
        ...
        if ($exception instanceof \ErrorException) {
            // ErrorExceptions wrap the php-fpm-error types within the 'severity' property
     ...
     * depends on the 'auto_globals_jit' php-fpm.ini setting.
     *
