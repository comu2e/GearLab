...
<?php-fpm $component->withAttributes(['.$this->attributesToString($attributes->all(), $escapeAttributes = $class !== DynamicComponent::class).']); ?>';
    }
    ...
    protected function compileAttributeEchos(string $attributeString)
    {
        ...
        $value = str_replace('<?php-fpm echo ', '\'.', $value);
