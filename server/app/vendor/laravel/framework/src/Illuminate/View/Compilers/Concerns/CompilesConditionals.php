...
trait CompilesConditionals
{
    ...
    protected function compileAuth($guard = null)
    {
        ...
        return "<?php-fpm if(auth()->guard{$guard}->check()): ?>";
    }
    ...
    protected function compileElseAuth($guard = null)
    {
        ...
        return "<?php-fpm elseif(auth()->guard{$guard}->check()): ?>";
    }
    ...
    {
        return "<?php-fpm if(app()->environment{$environments}): ?>";
    }
    ...
    {
        return "<?php-fpm if(app()->environment('production')): ?>";
    }
    ...
    protected function compileGuest($guard = null)
    {
        ...
        return "<?php-fpm if(auth()->guard{$guard}->guest()): ?>";
    }
    ...
    protected function compileElseGuest($guard = null)
    {
        ...
        return "<?php-fpm elseif(auth()->guard{$guard}->guest()): ?>";
    }
    ...
    {
        return "<?php-fpm if (! empty(trim(\$__env->yieldContent{$expression}))): ?>";
    }
    ...
    {
        return "<?php-fpm elseif{$expression}: ?>";
    }
    ...
    {
        return "<?php-fpm if(isset{$expression}): ?>";
    }
    ...
    protected function compileSwitch($expression)
    {
        ...
        return "<?php-fpm switch{$expression}:";
    }
    ...
    protected function compileCase($expression)
    {
        ...
        return "<?php-fpm case {$expression}: ?>";
    }
    ...
    protected function compileOnce($id = null)
    {
        ...
        return '<?php-fpm if (! $__env->hasRenderedOnce('.$id.')): $__env->markAsRenderedOnce('.$id.'); ?>';
    }
