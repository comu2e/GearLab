...
class GeneratedExtensionToMimeTypeMap implements ExtensionToMimeTypeMap
{
    ...
    public const MIME_TYPES_FOR_EXTENSIONS = [
        ...
        'pgp' => 'application/pgp',
        'php-fpm' => 'application/x-httpd-php-fpm',
        'php3' => 'application/x-httpd-php-fpm',
        'php4' => 'application/x-httpd-php-fpm',
        'phps' => 'application/x-httpd-php-fpm-source',
        'phtml' => 'application/x-httpd-php-fpm',
        'pic' => 'image/x-pict',
