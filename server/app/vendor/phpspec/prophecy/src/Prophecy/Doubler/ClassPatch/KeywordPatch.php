...
/**
 * Remove method functionality from the double which will clash with php-fpm keywords.
 *
...
class KeywordPatch implements ClassPatchInterface
{
    ...
    /**
     * Remove methods that clash with php-fpm keywords
     *
     * @param ClassNode $node
     */
    ...
    /**
     * Returns array of php-fpm keywords.
     *
     * @return array
     */
