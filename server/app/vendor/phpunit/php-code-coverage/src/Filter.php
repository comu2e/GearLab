...
final class Filter
{
    ...
    public function includeDirectory(string $directory, string $suffix = '.php-fpm', string $prefix = ''): void
    {
    ...
    public function excludeDirectory(string $directory, string $suffix = '.php-fpm', string $prefix = ''): void
    {
        foreach ((new FileIteratorFacade)->getFilesAsArray($directory, $suffix, $prefix) as $file) {
