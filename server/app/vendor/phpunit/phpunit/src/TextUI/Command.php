...
class Command
{
    ...
    protected function handleArguments(array $argv): void
    {
        ...
        if (!isset($this->arguments['testSuffixes'])) {
            $this->arguments['testSuffixes'] = ['Test.php-fpm', '.phpt'];
        }
    ...
    protected function handlePrinter(string $printerClass, string $printerFile = '')
    {
        ...
        $outputStream = isset($this->arguments['stderr']) ? 'php-fpm://stderr' : null;
    ...
    private function generateConfiguration(): void
    {
        ...
        print 'Bootstrap script (relative to path shown above; default: vendor/autoload.php-fpm): ';
        ...
        if ($bootstrapScript === '') {
            $bootstrapScript = 'vendor/autoload.php-fpm';
        }
