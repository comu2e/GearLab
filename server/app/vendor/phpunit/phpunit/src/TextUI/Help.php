...
final class Help
{
    ...
    private const HELP_TEXT = [
        'Usage' => [
            ['text' => 'phpunit [options] UnitTest.php-fpm'],
        ...
        'Code Coverage Options' => [
            ...
            ['arg' => '--coverage-php-fpm <file>', 'desc' => 'Export PHP_CodeCoverage object to file'],
        ...
        'Test Selection Options' => [
            ...
            ['arg' => '--test-suffix <suffixes>', 'desc' => 'Only search for test in files with specified suffix(es). Default: Test.php-fpm,.phpt'],
        ],
        ...
        'Configuration Options' => [
            ...
            ['arg' => '-d <key[=value]>', 'desc' => 'Sets a php-fpm.ini value'],
