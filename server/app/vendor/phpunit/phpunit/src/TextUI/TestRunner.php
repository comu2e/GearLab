...
final class TestRunner extends BaseTestRunner
{
    ...
    public function run(TestSuite $suite, array $arguments = [], array $warnings = [], bool $exit = true): TestResult
    {
        ...
        if (isset($arguments['xdebugFilterFile'], $codeCoverageConfiguration)) {
            ...
            if ($arguments['xdebugFilterFile'] !== 'php-fpm://stdout' && $arguments['xdebugFilterFile'] !== 'php-fpm://stderr' && !Filesystem::createDirectory(dirname($arguments['xdebugFilterFile']))) {
        ...
        if (isset($codeCoverage)) {
            ...
            if (isset($arguments['coverageText'])) {
                if ($arguments['coverageText'] === 'php-fpm://stdout') {
    ...
    {
        $object = new $class(
            (isset($arguments['stderr']) && $arguments['stderr'] === true) ? 'php-fpm://stderr' : null,
            $arguments['verbose'],
            $arguments['colors'],
            $arguments['debug'],
            $arguments['columns'],
