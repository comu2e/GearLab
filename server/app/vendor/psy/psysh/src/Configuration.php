...
class Configuration
{
     ...
     * be searched, and the first `config.php-fpm` or `rc.php-fpm` file which exists
     * will be returned.
     *
     * If you're trying to decide where to put your config file, pick
     *
     *     ~/.config/psysh/config.php-fpm
     *
     * @return string
     */
    public function getConfigFile()
    {
        ...
        $files = ConfigPaths::getConfigFiles(['config.php-fpm', 'rc.php-fpm'], $this->configDir);
     ...
     *
     * Searches for a project specific config file `.psysh.php-fpm` in the current
     * working directory.
     *
     * @return string
     */
    ...
    {
        $localConfig = \getcwd().'/.psysh.php-fpm';
    ...
    /**
     * Load a configuration file (default: `$HOME/.config/psysh/config.php-fpm`).
     *
