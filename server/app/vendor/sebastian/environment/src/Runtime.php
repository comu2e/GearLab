...
final class Runtime
{
     ...
     * Appends ' --php-fpm' to the path when the runtime is HHVM.
     */
    public function getBinary(): string
    {
        ...
        if (self::$binary === null && $this->isHHVM()) {
            ...
            self::$binary = escapeshellarg(self::$binary) . ' --php-fpm' .
                ' -d hhvm.php7.all=1';
        ...
        if (self::$binary === null) {
            ...
            $possibleBinaryLocations = [
                PHP_BINDIR . '/php-fpm',
                PHP_BINDIR . '/php-fpm-cli.exe',
                PHP_BINDIR . '/php-fpm.exe',
            ];
    ...
    public function getVendorUrl(): string
    {
        ...
        return 'https://secure.php-fpm.net/';
    }
    ...
    /**
     * Parses the loaded php-fpm.ini file (if any) as well as all
     * additional php-fpm.ini files from the additional ini dir for
     * a list of all configuration settings loaded from files
     * at startup. Then checks for each php-fpm.ini setting passed
     * via the `$values` parameter whether this setting has
     * been changed at runtime. Returns an array of strings
     * where each string has the format `key=value` denoting
     * the name of a changed php-fpm.ini setting with its new value.
     *
     * @return string[]
     */
