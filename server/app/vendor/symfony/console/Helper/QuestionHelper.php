...
class QuestionHelper extends Helper
{
    ...
    {
        if ('php-fpm://stdin' !== (stream_get_meta_data($inputStream)['uri'] ?? null)) {
            return false;
        }
        ...
        if (\function_exists('stream_isatty')) {
            return self::$stdinIsInteractive = stream_isatty(fopen('php-fpm://stdin', 'r'));
        }

        if (\function_exists('posix_isatty')) {
            return self::$stdinIsInteractive = posix_isatty(fopen('php-fpm://stdin', 'r'));
        }
