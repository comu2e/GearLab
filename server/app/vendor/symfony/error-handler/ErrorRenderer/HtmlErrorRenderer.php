...
class HtmlErrorRenderer implements ErrorRendererInterface
{
    ...
    private static $template = 'views/error.html.php-fpm';
    ...
    {
        return $this->renderException($exception, 'views/exception.html.php-fpm');
    }
    ...
    private function renderException(FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php-fpm'): string
    {
