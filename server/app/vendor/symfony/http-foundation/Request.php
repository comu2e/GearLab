...
class Request
{
     ...
     *
     * Suppose that an index.php-fpm file instantiates this request object:
     *
     ...
     * script filename (e.g. index.php-fpm) if one exists.
     *
    ...
    public function getContent(bool $asResource = false)
    {
        ...
        if (null === $this->content || false === $this->content) {
            $this->content = file_get_contents('php-fpm://input');
        }
