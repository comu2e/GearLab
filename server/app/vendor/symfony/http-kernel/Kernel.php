...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    public function getBundle(string $name)
    {
        if (!isset($this->bundles[$name])) {
            throw new \InvalidArgumentException(sprintf('Bundle "%s" does not exist or it is not enabled. Maybe you forgot to add it in the "registerBundles()" method of your "%s.php-fpm" file?', $name, get_debug_type($this)));
        }
    ...
    {
        file_put_contents(($this->warmupDir ?: $this->getBuildDir()).'/annotations.map', sprintf('<?php-fpm return %s;', var_export($annotatedClasses, true)));
    }
    ...
    protected function initializeContainer()
    {
        ...
        $cache = new ConfigCache($buildDir.'/'.$class.'.php-fpm', $this->debug);
        ...
        if ($preload && method_exists(Preloader::class, 'append') && file_exists($preloadFile = $buildDir.'/'.$class.'.preload.php-fpm')) {
