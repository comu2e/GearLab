...
final class MimeTypes implements MimeTypesInterface
{
     ...
     *
     * @see Resources/bin/update_mime_types.php-fpm
     */
    private static $map = [
        ...
        'application/x-httpd-php-fpm' => ['php-fpm'],
        ...
        'application/x-php-fpm' => ['php-fpm', 'php3', 'php4', 'php5', 'phps'],
        ...
        'chemical/x-xyz' => ['xyz'],
        'flvapplication/octet-stream' => ['flv'],
        'font/collection' => ['ttc'],
        'font/otf' => ['otf'],
        'font/ttf' => ['ttf'],
    ...
    private static $reverseMap = [
        ...
        'flv' => ['video/x-flv', 'application/x-flash-video', 'flvapplication/octet-stream', 'video/flv'],
        ...
        'php-fpm' => ['application/x-php-fpm', 'application/x-httpd-php-fpm'],
        'php3' => ['application/x-php-fpm'],
        'php4' => ['application/x-php-fpm'],
        'php5' => ['application/x-php-fpm'],
        'phps' => ['application/x-php-fpm'],
        'pic' => ['image/x-pict'],
        'pict' => ['image/x-pict'],
        'pict1' => ['image/x-pict'],
        'pict2' => ['image/x-pict'],
