...
You can validates XLIFF contents passed from STDIN:
  ...
  <info>cat filename | php-fpm %command.full_name% -</info>

You can also validate the syntax of a file:

  <info>php-fpm %command.full_name% filename</info>

Or of a whole directory:

  <info>php-fpm %command.full_name% dirname</info>
  <info>php-fpm %command.full_name% dirname --format=json</info>
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (['-'] === $filenames) {
            return $this->display($io, [$this->validate(file_get_contents('php-fpm://stdin'))]);
        }
