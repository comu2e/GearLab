...
abstract class AbstractDumper implements DataDumperInterface, DumperInterface
{
    ...
    public static $defaultOutput = 'php-fpm://output';
    ...
    {
        $this->flags = $flags;
        $this->setCharset($charset ?: ini_get('php-fpm.output_encoding') ?: ini_get('default_charset') ?: 'UTF-8');
    ...
    public function dump(Data $data, $output = null)
    {
        ...
        if ($returnDump = true === $output) {
            $output = fopen('php-fpm://memory', 'r+b');
        }
        if ($output) {
